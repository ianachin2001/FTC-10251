...
public class HDriveTeleOpRed extends OpMode {
    ...
    public HDriveTeleOpRed(){
        start = System.currentTimeMillis();
    }
    public void init(){

        Arrays.fill(starting, false);
        double timesomething = System.currentTimeMillis();
        ...
        double timesomethingelse = System.currentTimeMillis() - timesomething;
        telemetry.addData("Gyro", timesomethingelse);
        telemetry.update();
